---
title: "TP3: Estudio de modelos lineale"
format:
    pdf:
...
un modelo, mientras que el archivo `tp_test.csv` tiene 20 observaciones que se usarán para evaluar 
...
Compare lppd para los polinomios de grados 3, 4, 5 y 6 ajustados con 20 observaciones. 
