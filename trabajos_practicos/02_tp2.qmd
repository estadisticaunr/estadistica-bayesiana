...
El algoritmo de Metropolis-Hastings permite obtener muestras de una distribución de probabilidad $f^*(\theta)$, incluso aunque esta sea impropia (es decir, incluso aunque sea desconocida la constante de normalización que hace que la integral en el soporte de la función sea igual a uno). Basta con que podamos evaluar $f^*(\theta)$ en cualquier valor de $\theta$.
