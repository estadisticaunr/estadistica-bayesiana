...
El algoritmo de Metropolis-Hastings permite obtener muestras de una distribución de 
...
diferentes distribuciones de propuesta de transición: normal de una varianza dada y beta 
...
2.  Utilizando la función propuesta, obtener 3000 muestras de la distribución dada por
    ...
    diferente. Compare utilizando histogramas y funciones de autocorrelación. 
    Elegir como punto inicial...**To Do**
...
4.  Estimar el MCSE de los valores de $\mathbb{E}(X)$ para cada una de las seis cadenas 
    anteriores.
