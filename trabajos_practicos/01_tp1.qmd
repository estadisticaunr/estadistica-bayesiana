...
En todos los escenarios, consideremos que la creencia _a priori_ para 
$\theta_a$, $\theta_b$ y $\theta_c$ se corresponde con una distribución $\mathrm{Beta}(2,2)$

## Completamente al azar

Esta es la estrategia (o no-estrategia) más elemental: cada día, elegir una máquina al azar para jugar con igual probabilidad. 

## _Greedy_ con tasa observada

Se elige la máquina que tenga la mayor tasa de éxito observada hasta el momento.

## _Greedy_ con probabilidad _a posteriori_ (SE PODRÍA SACAR)
...
Se selecciona la máquina que tenga el mayor extremo derecho de un intervalo de credibilidad (construido a partir de la distribución _a posteriori_).
...
<!-- Para todo lo que sigue de aquí en adelante, consideremos que la creencia _a priori_ para $\theta_a$, $\theta_b$ y $\theta_c$ es $\mathrm{Beta}(2,2)$ -->

<!-- ## Completamente al azar

Considere la estrategia (o no-estrategia) más elemental: cada día, elegir una máquina al azar para jugar. 

1. Construya una función en `R` que elija una máquina al azar con probabilidad uniforme, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
2. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
3. Simule 1000 secuencias de 366 días de juego y analice los resultados.

## _Greedy_ con tasa observada

Se elige la máquina que tenga la mayor tasa de éxito observada hasta el momento.

4. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
5. ¿Podría considerarse bayesiano este método de elección de máquina?
6. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
7. Simule 1000 secuencias de 366 días de juego y analice los resultados.

## _Greedy_ con probabilidad _a posteriori_ (SE PODRÍA SACAR)

Se elige la máquina que tenga, hasta el momento, mayor probabilidad de éxito promedio _a posteriori_.

8. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
9. ¿Podría considerarse bayesiano este método de elección de máquina?
10. Utilice su función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
11. Simule 1000 secuencias de 366 días de juego y analice los resultados.

## _$\epsilon$-greedy_ (con tasa observada)

Se selecciona la mejor máquina (la de mayor tasa de éxito observada según los datos actuales) con una probabilidad de $1-\epsilon$ y se elige una máquina al azar con una probabilidad $\epsilon$. 

12. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
13. ¿Podría considerarse bayesiano este método de elección de máquina?
14. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
15. Simule 1000 secuencias de 366 días de juego y analice los resultados.
...
16. Implemente la función _softmax_ que, dadas tres tasas observadas, devuelva la probabilidad de elegir cada máquina. La función debe recibir la "temperatura" como argumento.
17. Explique qué función cumple el parámetro de "temperatura" en términos de explorar versus explotar.
18. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
19. ¿Podría considerarse bayesiano este método de elección de máquina?
20. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
21. Simule 1000 secuencias de 366 días de juego y analice los resultados.

## _Upper-bound_

Se selecciona la máquina que tenga el mayor extremo derecho de un intervalo de credibilidad (construido a partir de la distribución _a posteriori_).

22. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
23. ¿Podría considerarse bayesiano este método de elección de máquina?
24. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
25. Simule 1000 secuencias de 366 días de juego y analice los resultados.

## _Thompson sampling_

Para seleccionar una máquina, se toma una muestra de la distribución _a posteriori_ de las probabilidades de éxito de cada máquina y se elige la máquina correspondiente a la muestra más grande.

26. Construya una función en `R` que elija una máquina sigiendo este método, obtenga un resultado (éxito o fracaso) y actualice la credibilidad sobre los posibles valores de la probabilidad de éxito correspondiente. 
27. ¿Podría considerarse bayesiano este método de elección de máquina?
28. Explique intuitivamente por qué este método balancea exploración y explotación.
29. Utilice esa función para simular una secuencia de 366 días de juego. Registre la evolución diaria del dinero acumulado cada día, la cantidad de veces que se juega en cada máquina, y la distribución _a posteriori_ de cada probabilidad de éxito. Muestre gráficamente los resultados.
30. Simule 1000 secuencias de 366 días de juego y analice los resultados.
