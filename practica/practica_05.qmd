...
1.  **Control de armas**
    ...
    $\text{log}(\lambda_i) = \boldsymbol{X}_i\boldsymbol{\beta}$. Use distribuciones a priori no 
    informativas y $p = 7$ de las covariables en $\boldsymbol{X}_i$: el intercepto, los cinco 
