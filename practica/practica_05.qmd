...
1.  Descargue el conjunto de datos `babynames` en `R` y calcule el log-odds de un bebé 
...
1.  Utilice el conjuto de datos `airquality` que viene con el paquete `{datasets}` que se 
