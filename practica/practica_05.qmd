...
1.  Considere un modelo para datos de conteo con un predictor lineal $X$ que toma valores entre -3 y 50
...
1.  Considere un modelo de clasificación con un predictor lineal $X$ que toma valores entre -30 y 10
...
knitr::kable(challenger, col.names = c("T (°F)", "Falla")) |> kableExtra::kable_styling(full_width = F)
```
