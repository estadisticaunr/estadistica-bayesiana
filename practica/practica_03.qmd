...
1.  Una máquina que se utiliza para ensamblar teléfonos celulares en una fábrica en 
    Tierra del Fuego cuenta con tres componentes críticos. Ante una falla en cualquiera
    de estos componentes, la máquina se detiene. Las probabilidades de que estos elementos
    operen correctamente durante un día cualquiera  son $p_1 = 0.8$, $p_2 = 0.9$ y 
    $p_3 = 0.7$. Responda las siguientes preguntas utilizando técnicas de simulación

    i.  ¿Cuál es la probabilidad de que la máquina falle en el día 1 de uso?
    ...
    i.  Sea $T=\text{Cantidad de días que la máquina funciona ininterrumpidamente}$. 
