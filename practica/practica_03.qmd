...
1.  **A jugar con la distribución de propuesta**
    ...
    Suponga que se desean obtener muestras de una distribución $\text{Normal}(4, 1)$ 
...
1.  **Modelo Poisson**
    ...
    Sea $Y_t$ la cantidad de especies descubierta en el año $2009 + t$ (e.g. $Y_1 = 64$ 
    ...
    Ajuste el siguiente modelo utilizando Metropolis-Hastings y verifique que el _sampler_
    convergiera.
    <!-- @Reich2020 3.10/3.11  -->

1.  **Metropolis-Hastings multivariado**

    Obtener muestras de una distribucion normal multivariada.

1.  **Metropolis-Hastings para regresión**

    Reciclar el ejercicio de grid-approximation?
...
1.  **Problemitas de MCMC**
    ...
    Para cada escenario de simulación mediante MCMC descrito a continuación, describa 
...
1.  Repetir los cálculos de alguno de los puntos anteriores utilizando 4 cadenas y 
    calcular $\hat{R}$?
...
1.  **Cadenas rotas: Un caso simulado**
...
1.  **Cadenas rotas: Un caso real**
    ...
    gráficos y explique por qué no utilizaría estas muestras para obtener conclusiones sobre
    el _posterior_.

    <center> **Gráfico 1** </center>
    ```{r, echo=FALSE, out.width="100%", fig.align="center"}
    if (is_html) knitr::include_graphics(file.path("imgs", "posterior_rota.png"))
    ```
    
    <center> **Gráfico 2** </center>
    ```{r, echo=FALSE, out.width="100%", fig.align="center"}
    if (is_html) knitr::include_graphics(file.path("imgs", "posterior_rota_2.png"))
    ```
