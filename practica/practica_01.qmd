...
1.  Escribir la expresión matemática para cada una de las siguientes descripciones verbales:
    ...
    g.  **To Do** Algunas descripciones no estan cubiertas en la **Unidad 1**. <!-- @Martin2021 -->
...
2.  El test ~~in~~falible
    ...
    -   Si realizamos el mismo análisis una segunda vez sobre el mismo paciente y obtenemos nuevamente positivo
        ...
        -   ¿Y si diera negativo?
        -   ¿Es el a priori el mismo para el segundo análisis que para el primero? <!-- @Martin2021 -->
...
5.  Árboles enfermos
    ...
    Los árboles enfremos se componen en un 15% por jacarandás, 80% de ceibos, y 5% de otras especies [^1].
    Los árboles sanos se componen por un 20% de jacarandás, 10% de ceibos, y 70% de otras especies.
    Con el objetivo de monitorear cuanto se propagó la enfermedad, una de las personas que trabaja en el vivero selecciona al azar uno de los árboles para testear.
    ...
    -   Compare las probabilidades a priori y a posteriori de que el árbol tenga moho. ¿Cómo afecta el análisis el saber que el árbol es un ceibo? <!-- @Johnson2021 -->
...
6.  Transporte El Impuntual
    ...
    -   El colectivo de Franco no está demorado. ¿Cuál es la probabilidad de que esté viajando en uno de los colectivos de la mañana? <!-- @Johnson2021 -->
...
7.  Bebé panda
    ...
    -   Un tiempo después sos encontramos con que en la segunda parición da a luz a un único bebé panda. ¿Cuál es la probabilidad de que este panda sea de la especie A? <!-- @McElreath2020 -->
...
8.  Demuestra la validez de la siguiente expresión de la regla de Bayes
    ...
    iv. Junte las partes para formar la regla de Bayes. <!-- @Hoff2009 --> <!-- Se necesitan los axiomas P1-P3 del capitulo 2. -->
...
10. Estás a punto de subir a un avión rumbo a Seattle.
...
11. Dos personas dejaron rastros de sangre en la escena del crimen.
...
12. Nos encontramos con alguien en la calle y nos dice que tiene dos hijxs.
...
13. Elvis Presley tenía un hermano varón que nació en el mismo parto pero que murió al poco tiempo.
...
14. Dos cajones contienen medias.
...
15. _Prosecutor's Fallacy_
    ...
    Luego de pasar 3 años en priosión, Clark fue liberada en 2003 luego de que se determinara que el testimonio _experto_ de Meadows era equivocado. Dos mujeres, a las cuales el testimonio de Meadows había enviado a prisión, también fueron liberadas.
    
    i. Identifica una falla en la probabilidad de $\frac{1}{73000000}$ dada por Meadows
    ii. Incluso aceptando el número anterior como correcto, ¿cuál es el problema de interpretar esa probabilidad como la probabilidad de inocencia de Clark?
    
    <!-- https://web.stanford.edu/class/archive/cs/cs109/cs109.1206/section/1/section1_soln.pdf -->
    

[^1]: Hay gente que dice que "cada dos por tres" te deja a pata.
...
4.  Un amigo arroja un dado y anota en secreto el número que sale (llamémoslo $T$).
...
6.  Cansada de los experimentos de arrojar una moneda cientos de veces al aire, una estudiante diseña un sistema de reconocimiento de imágenes que determina si salió cara o ceca y registra el resultado.
    ...
    ii. ¿Qué ocurre a medida que la probabilidad de clasificar mal varía? <!-- http://allendowney.github.io/ThinkBayes2/chap04html -->
...
8.  Supongamos que existe un idioma con seis palabras:
...
1.  Voy a conseguir esa pasantía
    ...
    La empresa de tecnología en la que todo el mundo quiere trabajar tiene varias vacantes para pasantes en ciencia de datos.
    Luego de leer la descripción de la búsqueda, te das cuenta que sos una persona calificada para el puesto: estos son tus **datos**.
    ...
    iii. ¿Qué pregunta tiene más sentido responder: la frecuentista o la Bayesiana? Justifica tu respuesta. <!-- @Johnson2021 -->
...
2.  Beneficios de la Estadística Bayesiana
    ...
    ii. ¿Cuáles son las similitudes entre el enfoque frecuentista y el Bayesiano? <!-- @Johnson2021 -->
