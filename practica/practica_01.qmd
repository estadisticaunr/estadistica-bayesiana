...
1.  En un estudio que utiliza métodos de la Estadística Bayesiana para predecir el número de especies que serán descubiertas en el futuro se reporta que la cantidad de especies marinas bivalvas[^2] descubiertas cada año entre 2010 y 2015 fue 64, 13, 33, 18, 30 y 20.
    \
...
1.  Un amigo arroja un dado y anota en secreto el número que sale (llamémoslo $T$).A continuación, nosotros, con los ojos vendados, arrojamos el dado varias veces.
...
1.  Cansado de los experimentos de arrojar una moneda cientos de veces al aire, un estudiante diseña un sistema de reconocimiento de imágenes que determina si salió cara o seca y registra el resultado.
...
1.  En las Jornadas Rosarinas de Ciencia de Datos, una expositora está dando una charla en un salón cuando el personal de seguridad la interrumpe porque cree que puede haber más de 1000 personas en la sala, superando el máximo permitido.
