...
1.  💻 📌 **Puede fallar...**
    ...
    * $\pi$: probabilidad de mala clasificación.
    ...
    Obtener $P(Y = 1)$ en base a la distribución conjunta de $X$ e $Y$ y luego realizar la
    inferencia utilizando esa probabilidad como probabilidad de éxito en  vez de $\theta$.
