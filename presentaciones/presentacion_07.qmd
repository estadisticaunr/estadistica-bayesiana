...
$\beta_0$ es la log-chance (_log-odds_) del evento de interés cuando todas las variables explicativas valen 0. $e^{\beta_0}$ es la chance. En términos del problema: _e^{\beta_0} es la chance de que llueva mañana si la humedad de hoy a las 9 de la mañana es 0_
...
$$e^{\beta_1} = \frac{\mathrm{odds}_{x+10}}{\mathrm{odds}_{x}} \Rightarrow \mathrm{odds}_{x+1} = e^{\beta_1} \mathrm{odds}_{x}$$
