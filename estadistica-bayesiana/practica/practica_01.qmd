...
1. ¿Es verdad que existen los vampiros? Versión Crepúsculo
    ...
    ![](imgs/crepusculo_vampiro.jpg){class="img-practica" width=70%}
...
1. Árboles enfermos
    ...
    * Compare las probabilidades a priori y a posteriori de que el árbol tenga moho. 
    ...
    ![](imgs/ceibo.jpg){class="img-practica" width=70%}
...
1. Transporte El Impuntual
    ...
    * El colectivo de Franco no está demorado. 
    ...
    ![Foto de <a href='https://unsplash.com/markuswinkler'>Markus Winkler</a> en <a href='https://unsplash.com/photos/HII6PEEvLHw'>Unsplash</a>](imgs/colectivo.jpg){class="img-practica" width=70%}
...
1. Bebé panda
    ...
    * Un tiempo después sos encontramos con que en la segunda parición da a luz a un único
    ...
    ![Foto de <a href='https://unsplash.com/stonewyq'>Stone Wang</a> en <a href='https://unsplash.com/photos/0wk7m5SVPsM'>Unsplash</a>](imgs/bebe_panda.jpg){class="img-practica" width=70%}
