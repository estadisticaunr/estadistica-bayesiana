...
1. ¿Es verdad que existen los vampiros? Versión Crepúsculo
    ...
    <center>
        <img src="imgs/crepusculo_vampiro.jpg" style="width: 500px"></img>
    </center>
...
1. Árboles enfermos
    ...
    * Compare las probabilidades a priori y a posteriori de que el árbol tenga moho. 
    ...
    <center>
        <img src="imgs/ceibo.jpg" style="width: 500px"></img>
    </center>
...
1. Transporte El Impuntual
    ...
    * El colectivo de Franco no está demorado. 
    ...
    <center>
        <figure>
        <img src="imgs/colectivo.jpg" style="width: 500px"></img>
        <figcaption>
...
1. Bebé panda
    ...
    * Un tiempo después sos encontramos con que en la segunda parición da a luz a un único
    ...
    <center>
        <figure>
        <img src="imgs/bebe_panda.jpg" style="width: 500px"></img>
        <figcaption>
