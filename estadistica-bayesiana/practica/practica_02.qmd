...
1.  En un campamento de verano para infantes se realizaron actividades que promueven el
    ...
    i. Verificar el cálculo utilizando `R`.
    i. Calcular un intervalo de credibilidad del 95% para $\theta$.
        a. A mano
        a. Usando `R`

    <figure>
    <img src="imgs/almaciguera_tomates.jpg" class="img-practica"></img>
    <figcaption>
        Foto de <a href="https://unsplash.com/@markusspiske">Markus Spiske</a> en 
        <a href="https://unsplash.com/photos/vrbZVyX2k4I">Unsplash</a></figcaption>
    </figure>
...
1.  `Modern Data Science with R` 
    ...
    **To Do** Explicar el juego.
     ...
     <img src="imgs/monty_hall.png" class="img-practica"></img>
